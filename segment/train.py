...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="E:/yolov5-master/yolov5-master/models/yolov5n.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/ASLseg.yaml", help="dataset.yaml path")
